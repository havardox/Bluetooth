    ...
    private final BroadcastReceiver mBroadcastReceiver2 = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothAdapter.ACTION_SCAN_MODE_CHANGED)) {
                ...
                int mode = intent.getIntExtra(BluetoothAdapter.EXTRA_SCAN_MODE, BluetoothAdapter
                        .ERROR);
                ...
                switch (mode) {
                    ...
                    case BluetoothAdapter.SCAN_MODE_CONNECTABLE:
                        Log.i(TAG, "mBroadcastReceiver2: Discoverability Disabled. Able to " +
                                "receive connections.");
                        break;
                    case BluetoothAdapter.SCAN_MODE_NONE:
                        Log.i(TAG, "mBroadcastReceiver2: Discoverability Disabled. Not able to " +
                                "receive connections.");
                        break;
...
//***remember the conncction will fail and app will crash if you haven't paired first
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mBluetoothAdapter == null) {
            Toast.makeText(MainActivity.this, "No bluetooth adapter found", Toast.LENGTH_LONG)
                    .show();
        }
